      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <!-- Brand -->
            <li class="menu-item active">
              <a href="admin-brand.php" class="menu-link">
            ...
            <!-- Product -->
            <li class="menu-item active">
              <a href="admin-product.php" class="menu-link">
                ...
                <div class="col-lg-12 mb-4 order-0">
                  <div class="card">
                    <div class="d-flex align-items-end row">
                      <div class="col-sm-7">
                        <div class="card-body">
                          <h5 class="card-title text-primary">Congratulations <?php echo $user; ?> 🎉</h5>
                          <p class="mb-4">
                  ...
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      <form action="" method="post">
                        ...
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="basic-icon-default-fullname">Select</label>
                          <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                        ...
                        <div class="row justify-content-end">
                          <div class="col-sm-10">
                            <button type="submit" name="brand-sub" class="btn btn-primary">Submit</button>
                          </div>
                        </div>
                      </form>
                    </div>
